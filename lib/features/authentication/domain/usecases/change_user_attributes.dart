...
class ChangeUserAttributes {
  ...
  Future<Either<Failure, User>> execute(String input, String? confirmationPassword, String? oldPassword, String userID, UserChangeType type) async {
    return await repository.changeUserAttributes(input, confirmationPassword, oldPassword, userID, type);
  }
}